...
_crate addWeaponCargoGlobal ["rhs_weap_maaws", 5];
_crate addItemCargoGlobal ["rhs_optic_maaws", 5];
_crate addMagazineCargoGlobal ["rhs_mag_maaws_HEAT", 10];
_crate addMagazineCargoGlobal ["rhs_mag_maaws_HEDP", 10];
