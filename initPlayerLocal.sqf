...
oddCtrl addAction ["Générer une mission", {[] remoteExec ["ODD_fnc_missions", 2];},[],1.5,true,true,"","CurrentMission==0",5];
oddCtrl addAction ["Nettoyer l'opération", {[] remoteExec ["ODD_fnc_clearZO", 2];},[],1.5,true,true,"","CurrentMission==1",5];
