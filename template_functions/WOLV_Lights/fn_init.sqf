...
WolvLights_var_genType = [
	// standard
		"Land_spp_Transformer_F", "Land_dp_transformer_F","Land_TBox_F",
	// compat CUP
		"Land_Trafostanica_mala","Land_Trafostanica_velka", "Land_Substation_01_F", "Land_PowLines_Transformer1_EP1",
...
WolvLights_var_petitPoteauType = [
	// standard
		"powerpolewooden_f.p3d","powerpolewooden_small_f.p3d","powerpolewooden_l_off_f.p3d","powerpolewooden_l_f.p3d","lampshabby_off_f.p3d",
	...
	// CUP
		...
		"powlines_conc2_ep1.p3d", "powlines_conc2a_ep1.p3d", "powlines_conc2l_ep1.p3d", "powlines_conc1_ep1.p3d",
	// compat DLC contact
...
WolvLights_var_moyenPoteauType = [
	// Altis
		"highvoltagecolumn_f.p3d",
	// Malden
		"powerline_01_pole_junction_f.p3d","powerline_01_pole_small_f.p3d","powerline_01_pole_tall_f.p3d", "powerline_01_pole_transformer_f.p3d",
	// Tanoa
		"powerline_01_pole_end_v1_f.p3d","powerline_01_pole_end_v2_f.p3d","powerline_01_pole_lamp_f.p3d",
	// compatibilité JBAD
		"jbad_powlineb.p3d", "powlinea_ep1.p3d",
	// CUP
		 "powlineb_ep1.p3d"
	];	//liste des moyen Poteaux

WolvLights_var_grandPoteauType = [
	// standard
		"highvoltagetower_largecorner_f.p3d","highvoltagetower_large_f.p3d","highvoltageend_f.p3d",
	// compat CUP
		"sloup_vn.p3d"
