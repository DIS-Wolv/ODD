...
*
* Exemple :
* [_return, _nbIa, _BaseIa] call ODDadvanced_fnc_testRenfort
* [_return, _nbIa, _BaseIa, True] call ODDadvanced_fnc_testRenfort
*
* Variable publique :
*/
...
if (_BaseIa / 2 > _nbIa and _return) then {
	...
	[["Test renfort %1 / %2 => %3 ", _nbIa, _BaseIa, _rdm]] call ODDadvanced_fnc_log;
	if (round(random (1 max _rdm)) == 0) then {	
		[_zo] spawn ODDadvanced_fnc_createRenfort; 
