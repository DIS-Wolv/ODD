...
if (ODD_var_FirstDefinition) then {
	...
	ODD_var_IEDCover = ["Land_PlasticNetFence_01_roll_F", "Land_WoodenCounter_01_F", "Land_Rack_F", "Land_ShelvesWooden_F", "Land_ShelvesWooden_blue_F", "Land_ShelvesWooden_khaki_F", "RoadCone_F", "Land_RoadCone_01_F", "RoadCone_L_F", "Land_CinderBlock_01_F", "Land_WheelCart_F", "Land_CzechHedgehog_01_new_F", "Land_CzechHedgehog_01_old_F", "Land_Fortress_01_bricks_v2_F", "Land_GarbageBin_02_F", "Land_Pillow_old_F", "PowerCable_01_Roll_F", "Land_PaperBox_01_small_destroyed_brown_IDAP_F", "Land_PaperBox_01_small_ransacked_brown_F", "Land_FoodSack_01_dmg_brown_F", "Land_FoodSack_01_empty_brown_idap_F", "Land_FoodSack_01_full_white_idap_F", "Land_GarbageHeap_02_F", "Land_Tyre_F", "Land_GarbageBin_01_F", "Tire_Van_02_F", "Land_KartStand_01_F", "Land_ToolTrolley_02_F", "Land_ToolTrolley_01_F", "Land_WeldingTrolley_01_F", "Land_Portable_generator_F", "Land_GarbagePallet_F", "Land_GarbageBin_03_F", "Land_GarbageContainer_closed_F", "Land_GarbageContainer_open_F", "Land_WheelieBin_01_F", "Land_DieselGroundPowerUnit_01_F", "Land_PressureWasher_01_F", "WaterPump_01_forest_F", "Land_WoodenCart_F", "Land_LiquidDispenser_01_F"]
		+ ODD_var_CivilianVehicles;
