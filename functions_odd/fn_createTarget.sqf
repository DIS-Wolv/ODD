...
if (_Mission == TargettypeName select 0) then {
    ...
    // cree la tache
    _task = [true, "Task", [format[missionNamespace getVariable "ODD_textCaisse", text _zo], "Détruire les caisses", "ODdoBJ"], objNull, "CREATED", 2] call BIS_fnc_taskCreate;
...
if (_Mission == TargettypeName select 1) then {
    ...
    // cree la tache
    _task = [true, "Task", [format[missionNamespace getVariable "ODD_textHVT", text _zo], "Neutraliser une HVT", "ODdoBJ"], objNull, "CREATED", 2] call BIS_fnc_taskCreate;
...
if (_Mission == TargettypeName select 2) then {
    ...
    _task = [true, "Task", [format[missionNamespace getVariable "ODD_textSecure", text _zo], "Sécuriser la zone", "ODdoBJ"], objNull, "CREATED", 2] call BIS_fnc_taskCreate;
...
if (_Mission == TargettypeName select 3) then {
    ...
    // cree la tache
    [true, "Task", [format[missionNamespace getVariable "ODD_textIntel", text _zo], "Récupérer des informations", "ODdoBJ"], objNull, "CREATED", 2] call BIS_fnc_taskCreate;
...
if (_Mission == TargettypeName select 4) then {
    ...
    // cree la tache
    _task = [true, "Task", [format[missionNamespace getVariable "ODD_textHelico", text _zo], "Récupérer les boîtes noires", "ODdoBJ"], objNull, "CREATED", 2] call BIS_fnc_taskCreate;
...
if (_Mission == TargettypeName select 5) then {
    ...
    // cree la tache
    _task = [true, "Task", [format[missionNamespace getVariable "ODD_textPrisoniers", text _zo], "Sauver le pilote allié", "ODdoBJ"], objNull, "CREATED", 2] call BIS_fnc_taskCreate;
...
if (_Mission == TargettypeName select 6) then {
    ...
    // cree la tache
    _task = [true, "Task", [format[missionNamespace getVariable "ODD_textVL", text _zo], "Securiser le véhicule", "ODdoBJ"], objNull, "CREATED", 2] call BIS_fnc_taskCreate;
