...
_moudrou = createLocation ["NameLocal", [18214,8894,0], 100, 100];
_moudrou setText "Moudrou";

_pefkasBase = createLocation ["NameLocal", [20649,20102,0], 100, 100];
_pefkasBase setText "Pefkas military base";

_AgiosTheodoros = createLocation ["NameLocal", [22452,20050,0], 250, 250];
